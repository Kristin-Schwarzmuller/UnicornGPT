...
class EasterEggs:
    ...
    def __init__(self):
        self.easter_eggs = [
            ...
            EasterEgg(["moon", "line"], "Wait, I Maybe I have a app for that. Let me check."),
            EasterEgg(["better"], "Maybe I have a plugin for that"),
            EasterEgg(["sound", "engineer"], "You have to understand how to set the compressor correctly"),
            ...
            EasterEgg(["backpack"], "My backpack is too big? Oh I am sorry, Sir! It must be all the sweets"),
            ...
            EasterEgg(["ayahuasca"], "You wanna find yourself? Alright, but did you prepare your Excel sheet?"),
            EasterEgg(["double"], "Double wougle, hihihihihihihihi"), 
            EasterEgg(["engine"], "Engine"),
            EasterEgg(["Maffay"], "I would love to answer that but You stole all the words. Shutting down now."),
            EasterEgg(["Feta"], "Catherine Feta Jones my name, nice to meet you? Do you have cheese?"),
            EasterEgg(["lion", "king"], "Mufasa! The circle of life... Or the circle of candies?"), 
            EasterEgg(["extra"], "Raggadagga, Raggadagga, Raggadagga"), 
            EasterEgg(["shovel"], "Sorry I did not get that. Do you mean, your majesty King shovel the first? "), 
